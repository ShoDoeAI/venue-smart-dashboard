...
async function checkJuly2025Total() {
  console.log('🔍 Checking July 2025 revenue total\n');

  // Get all July 2025 data from revenue_overrides
  ...
  console.log(`📊 Found ${data.length} days with data in July 2025:\n`);
