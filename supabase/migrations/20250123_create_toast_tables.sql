...
-- Grant permissions
GRANT SELECT ON toast_orders TO authenticated;
GRANT SELECT ON toast_checks TO authenticated;
GRANT SELECT ON toast_payments TO authenticated;
GRANT SELECT ON toast_selections TO authenticated;
GRANT SELECT ON toast_menu_items TO authenticated;
GRANT SELECT ON toast_employees TO authenticated;
GRANT SELECT ON toast_restaurant_info TO authenticated;
GRANT SELECT ON toast_transactions TO authenticated;

-- Success message
DO $$
BEGIN
    RAISE NOTICE 'Toast tables created successfully!';
END $$;