...
exports.testOpenDateIntegration = testOpenDateIntegration;
const shared_1 = require("@venuesync/shared");
/**
...
async function testOpenDateIntegration() {
    ...
    try {
        const connector = new shared_1.OpenDateConnector(credentials, config, mockSupabase);
        // Test 1: Connection
        ...
        if (connectionResult.success && credentialsValid) {
            ...
            const settlementsResult = await connector.fetchSettlements(undefined, // All venues
            ...
            const analyticsResult = await connector.fetchAnalytics(undefined, // All venues
            ...
            const transactionsResult = await connector.fetchAllTransactions(undefined, // All venues
...
//# sourceMappingURL=test-opendate.js.map