...
async function handler(req, res) {
    ...
    try {
        ...
        // Fetch transactions
        const result = await connector.fetchAllTransactions(locationId, startTime, endTime);
        if (!result.success) {
        ...
        if (transactions.length > 0) {
            const saveResult = await connector.saveTransactions(transactions, snapshot.created_at);
...
//# sourceMappingURL=fetch-toast-data.js.map