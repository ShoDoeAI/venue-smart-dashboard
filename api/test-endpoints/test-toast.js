...
const supabase = (0, supabase_js_1.createClient)(process.env.SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.SUPABASE_SERVICE_ROLE_KEY);
async function handler(req, res) {
    ...
    try {
        ...
        const connector = new shared_1.ToastConnector({
            id: 'test-toast-api',
            service: 'toast',
            isActive: true,
            credentials: {
        ...
        const transactionsResult = await connector.fetchAllTransactions(location.id || location.guid, startTime, endTime);
...
//# sourceMappingURL=test-toast.js.map