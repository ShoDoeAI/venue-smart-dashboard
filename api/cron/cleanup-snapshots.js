...
const snapshot_service_1 = require("../../src/services/snapshot-service");
/**
...
async function handler(req, res) {
    ...
    try {
        ...
        const snapshotService = new snapshot_service_1.SnapshotService(supabase);
        // Process each venue
        ...
        const { error: toastCleanupError } = await supabase
            ...
            .delete()
            .not('snapshot_timestamp', 'in', `(SELECT created_at FROM venue_snapshots)`);
