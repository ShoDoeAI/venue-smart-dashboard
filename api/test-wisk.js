...
exports.testWiskIntegration = testWiskIntegration;
...
async function testWiskIntegration() {
    ...
    try {
        const connector = new shared_1.WiskConnector(credentials, config, mockSupabase);
        // Test 1: Connection
        ...
        if (connectionResult.success && credentialsValid) {
            ...
            if (inventoryResult.success && inventoryResult.data) {
                ...
                if (movementsResult.success && movementsResult.data) {
                    ...
                    const transactionsResult = await connector.fetchAllTransactions(undefined, // All locations
                ...
                const wasteResult = await connector.fetchWasteEntries(undefined, // All locations
                ...
                const analyticsResult = await connector.fetchInventoryAnalytics(undefined, // All locations
                new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(), // Last 30 days
                new Date().toISOString());
...
//# sourceMappingURL=test-wisk.js.map