...
async function handler(req, res) {
    ...
    try {
        ...
        const connector = new shared_1.ToastConnector(creds, connectorConfig, supabase);
        ...
        // Fetch orders
        const ordersResult = await connector.fetchOrders(creds.credentials.locationGuid, startDate, endDate);
